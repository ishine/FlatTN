...
b1=p2+'/train.char.bmes'
b2=p2+'/dev.char.bmes'
b3=p2+'/test.char.bmes'

tt1 = codecs.open(t1, 'w', 'utf-8')
tt2 = codecs.open(t2, 'w', 'utf-8')
tt3 = codecs.open(t3, 'w', 'utf-8')
bb1 = codecs.open(b1, 'w', 'utf-8')
bb2 = codecs.open(b2, 'w', 'utf-8')
bb3 = codecs.open(b3, 'w', 'utf-8')
...
for se in dd:
    ...
    #得到tn_S, NSW以片段级别标注为S-标签，字以S-SELF标注
        for label in labels:
            word=text[label[0]:label[1]]
